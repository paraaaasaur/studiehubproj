				...
				<form:form method="POST" modelAttribute="EventInfo" enctype='multipart/form-data'>
					<table border="1">
						...
						<tr>
							<td>報名開始時間:</td>
							<td>
								<form:input type="datetime-local" path="registration_starttime" />
						...
						<tr>
							<td>報名結束時間:</td>
							<td>
								<form:input type="datetime-local" path="registration_endrttime" />
						...
						<tr>
							<td>活動開始時間:</td>
							<td>
								<form:input type="datetime-local" path="Transienta_startTime" />
						...
						<tr>
							<td>活動結束時間:</td>
							<td>
								<form:input type="datetime-local" path="Transienta_endTime" />
						...
						<tr>
							<td>活動說明:</td>
							<td>
								<form:textarea path="transientcomment" cols="100" rows="10" />
						...
						<tr>
							<td>報名人數上限</td>
							<td>
								<form:input  path="applicants"  placeholder="請填寫數字"/>
						...
						<tr>
							...
							<td>
								<input type="button" onclick="inport2()" value="一鍵輸入時間相近" class='primary one-click-demo'>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="button" onclick="inport()" value="一鍵輸入" class='primary one-click-demo'>
							</td>
						</tr>
					</table>
				</form:form>
