...
public final class UpdateProductForm {
	...
	public UpdateProductForm(Integer p_ID, String p_Name, String p_Class, Integer p_Price, String descString, MultipartFile imgFile, MultipartFile videoFile) {
		this.p_ID = p_ID;
		this.p_Name = p_Name;
