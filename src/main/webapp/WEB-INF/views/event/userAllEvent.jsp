...
<script>
	...
	window.addEventListener("load", function() {
		...
		eventQueryAll = document.getElementById("event-query-all");
		...
		eventQuery.addEventListener("click", function() {
		...
		eventQueryAll.addEventListener("click", function() {
			...
			<div class="inner">
				...
				<div align="center">
					...
					<div style="text-align: center;">
						...
						<button id="event-query" style="height:50px;font-size:10px;border-radius:10px;" >搜尋</button>&nbsp;
						<button id="event-query-all"  style="height:50px;font-size:10px;border-radius:10px;" >搜尋全部</button>
						<br><br>
					</div>
				</div>
