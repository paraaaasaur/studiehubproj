...
public final class UpdateProfileView {
	...
	private final MultipartFile uploadImage = null;


	public UpdateProfileView(String u_id, String u_lastname, String u_firstname, String u_address, String u_email, String u_tel, Date u_birthday, String u_gender) {
		this.u_id = u_id;
