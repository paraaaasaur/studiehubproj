...
public class UserController {
	...
	public String gotoUpdateUserinfo(Model model, @SessionAttribute User_Info loginBean) {
		...
		var view = userService.mapToUpdateProfileView(dbUser);
	...
	public String updateUser(
			UpdateProfileForm form, @SessionAttribute User_Info loginBean,
		...
		if (result.hasErrors()) {
			var view = userService.mapToUpdateProfileView(u_id, form);
			model.addAttribute("view", view);
