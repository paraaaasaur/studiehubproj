...
public final class UpdateEventForm {
	...
	public UpdateEventForm(String a_name, String a_type, String registration_starttime, String registration_endrttime, String transienta_startTime, String transienta_endTime, String a_address, String transientcomment, int applicants, MultipartFile eventImage) {
		this.a_name = a_name;
		this.a_type = a_type;
