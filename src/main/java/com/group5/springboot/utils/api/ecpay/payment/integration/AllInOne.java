...
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.AioCheckOutCVS;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.AioCheckOutDevide;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.AioCheckOutOneTime;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.AioCheckOutPeriod;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.AioCheckOutWebATM;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.CVSOrBARCODERequestObj;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.CreateServerOrderObj;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.DoActionObj;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.FundingReconDetailObj;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.InvoiceObj;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.QueryCreditCardPeriodInfoObj;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.QueryTradeInfoObj;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.QueryTradeObj;
import com.group5.springboot.utils.api.ecpay.payment.integration.domain.TradeNoAioObj;
import com.group5.springboot.utils.api.ecpay.payment.integration.ecpayOperator.EcpayFunction;
import com.group5.springboot.utils.api.ecpay.payment.integration.errorMsg.ErrorMessage;
import com.group5.springboot.utils.api.ecpay.payment.integration.exception.EcpayException;
import com.group5.springboot.utils.api.ecpay.payment.integration.verification.VerifyAioCheckOut;
import com.group5.springboot.utils.api.ecpay.payment.integration.verification.VerifyCreateServerOrder;
import com.group5.springboot.utils.api.ecpay.payment.integration.verification.VerifyDoAction;
import com.group5.springboot.utils.api.ecpay.payment.integration.verification.VerifyFundingReconDetail;
import com.group5.springboot.utils.api.ecpay.payment.integration.verification.VerifyQueryCreditTrade;
